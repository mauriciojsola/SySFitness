...
using FacebookGoogleLogin.Models;

namespace FacebookGoogleLogin.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    var callbackUrl = await SendEmailConfirmationTokenAsync(user);

                    ViewBag.Message = "Tu email no fué confirmado todavía. Por favor confirmalo para poder ingresar. Se envió un mail a tu casilla con instrucciones.";
                    return View("Info");
                }
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ViewBag.Message = "Revisá tu email y confirmá tu cuenta. Tenés que confirmar tu email antes de poder entrar por primera vez.";
